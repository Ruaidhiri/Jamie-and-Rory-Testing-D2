...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    answer_volume_of_cube = volume_of_cube(3)
    assert_equal(27, answer_volume_of_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
      answer_volume_of_sphere = volume_of_sphere(3)
      assert_equal(113.09724, answer_volume_of_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    answer_fahrenheit_to_celsius = fahrenheit_to_celsius(60)
    assert_equal(15.6, answer_fahrenheit_to_celsius)
  end
